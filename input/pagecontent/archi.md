...
* Radiation Observation resources: these resources allow describing a performed radiation act, as seen from modality perspective. They summarize the radiation report generated by the modality.
* Radiation Report resources: these resources reference the radiation observation resources, and enhance the collected information in a general radiation report, with relationship to the patient conditions and the procedure indications.
